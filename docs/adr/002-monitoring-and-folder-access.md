...
The final production browser harness uses this FSEvents boundary on an ignored workspace-backed disposable project. Real CSS and HTML writes cross the monitor and project pipeline before reaching Safari and Chromium, closing the end-to-end evidence gap recorded as ISS-008.
