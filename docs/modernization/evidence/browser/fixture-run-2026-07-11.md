...
- Safari 26.5.2 connected, sent protocol-7 hello, received CSS and page reload commands, acknowledged each reload, closed after page reload, and reconnected with hello. The corrected fixture was revalidated through SafariDriver on 2026-07-13: the initial stylesheet loaded, the CSS reload updated to a cache-busted URL, the reloaded stylesheet had two rules, and a fetch returned 200.
...
Safari corrected-stylesheet revalidation completed on 2026-07-13 using SafariDriver after the host enabled remote automation.
