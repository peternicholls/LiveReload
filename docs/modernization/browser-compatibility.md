...
|---|---:|---|---|---|---|---|
| OBS-001 | Safari | 26.5.2 | Sent protocol-7 hello; received server hello | Received `/styles.css` with `liveCSS=true` and updated stylesheet URL | Received `/index.html`; sent close, reconnected, and sent a new hello | supported for direct protocol fixture | Fixture events captured 2026-07-11 |
| OBS-002 | Google Chrome (headless) | 149.0.7827.201 | Sent protocol-7 hello; received server hello | Received `/styles.css` with `liveCSS=true` and updated stylesheet URL | Received `/index.html`; sent close, reconnected, and sent a new hello | supported for direct protocol fixture | Fixture events captured 2026-07-11 |
