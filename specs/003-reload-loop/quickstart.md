...
7. Run the five-minute idle sample and record CPU/resource cleanup evidence without retaining absolute paths, browser peer addresses, or private source contents.
